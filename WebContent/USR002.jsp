...
<body>
    ...
    <div id="sub_content">
        ...
        <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="id" name="id" readonly value="${res.userId }">
                </div>
            </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="name" name="name" value="${res.userName }">
                </div>
            </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="email" class="form-control" name="email" id="email" value="${res.userEmail }">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="password" class="form-control" id="name" name="password" value="${res.userPassword}">
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
                <input type="password" class="form-control" id="confirmPassword" name="compassword" >
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
